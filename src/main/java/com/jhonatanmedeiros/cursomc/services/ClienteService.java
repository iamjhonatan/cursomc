...
import com.jhonatanmedeiros.cursomc.services.exceptions.AuthorizationException;
import com.jhonatanmedeiros.cursomc.services.exceptions.DataIntegrityException;
...
public class ClienteService {
	...
	public Cliente findByEmail(String email) {
		...
		UserSS user = UserService.authenticated(); // usuário autenticado
	...
	public URI uploadProfilePicture(MultipartFile multipartFile) {
		...
		BufferedImage jpgImage = imageService.getJpgImageFromFile(multipartFile); // recebendo a imagem JPG extraída a partir do 'multipartFile'
